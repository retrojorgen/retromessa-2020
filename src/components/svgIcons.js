...
const Pacman = () => <img src={PacmanIcon} className="menu-icon" alt="icon" />
const Live = () => <img src={LiveIcon} className="menu-icon" alt="icon" />
const Schedule = () => (
  <img src={ScheduleIcon} className="menu-icon" alt="icon" />
)
const Vipps = () => <img src={VippsIcon} className="menu-icon" alt="icon" />
const Next = () => <img src={NextIcon} className="menu-icon" alt="icon" />
const SvgIcon = (props) => (
  <>
